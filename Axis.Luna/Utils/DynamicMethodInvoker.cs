    ...
    public class DynamicMethodInvoker
    {
        ...
        public DynamicMethodInvoker(MethodInfo method)
        {
            ...
            if (!method.IsStatic)
            {
                ...
                //invoke action: ((TargetClass)instance).Method(...)
                var cnt = 0;
        ...
        public R InvokeFunc<R>(object instance, params object[] @params) => (R)_funcInvoker(instance, @params);

        public object InvokeStaticFunc(params object[] @params) => _staticFuncInvoker(@params);
        public R InvokeStaticFunc<R>(params object[] @params) => (R)_staticFuncInvoker(@params);
