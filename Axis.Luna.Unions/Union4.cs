namespace Axis.Luna.Unions
{
    ...
    public readonly struct ValueUnion<T1, T2, T3, T4> :
        IUnion<T1, T2, T3, T4, ValueUnion<T1, T2, T3, T4>>
    {
        private readonly object _value;

        object IUnion<T1, T2, T3, T4, ValueUnion<T1, T2, T3, T4>>.Value => _value;
        ...
        public ValueUnion<T1, T2, T3, T4> WithMatch(
            Action<T1> t1Consumer,
            Action<T2> t2Consumer,
            Action<T3> t3Consumer,
            Action<T4> t4Consumer,
