...
namespace Axis.Luna.Common.Unions
{
    ...
    public abstract class RefUnion<T1, T2, T3, T4, T5, T6, TSelf> :
        IUnion<T1, T2, T3, T4, T5, T6, TSelf>
        where TSelf : RefUnion<T1, T2, T3, T4, T5, T6, TSelf>
    {
        private readonly object _value;

        object IUnion<T1, T2, T3, T4, T5, T6, TSelf>.Value => _value;
        ...
        protected RefUnion(object value)
        {
            ...
            {
                null => null,
                T1 or T2 or T3 or T4 or T5 or T6 => value,
    ...
    public readonly struct ValueUnion<T1, T2, T3, T4, T5, T6> :
        IUnion<T1, T2, T3, T4, T5, T6, ValueUnion<T1, T2, T3, T4, T5, T6>>
    {
        private readonly object _value;

        object IUnion<T1, T2, T3, T4, T5, T6, ValueUnion<T1, T2, T3, T4, T5, T6>>.Value => _value;
        ...
        public ValueUnion<T1, T2, T3, T4, T5, T6> WithMatch(
            Action<T1> t1Consumer,
            Action<T2> t2Consumer,
            Action<T3> t3Consumer,
            Action<T4> t4Consumer,
