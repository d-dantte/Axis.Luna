namespace GridLuck.Common.Unions
{
    public static class Union
    {
        ...
        public static bool IsType<T1, T2, TSelf>(
            this IUnion<T1, T2, TSelf> union,
            out T1? value)
            where TSelf : IUnion<T1, T2, TSelf>
            => union.Value.IsType(out value);
        ...
        public static bool IsType<T1, T2, T3, TSelf>(
        ...
        private static bool IsType<T>(this object? unionValue, out T? value)
        {
