namespace Axis.Luna.Unions.Tests
{
    ...
    public class Union4Tests
    {
        ...
        : RefUnion<int, decimal, float, string, MyRefUnion>
        {
        ...
        internal class All :
            RefUnion<int, decimal, float, string, All>,
            IUnionImplicits<int, decimal, float, string, All>,
            IUnionOf<int, decimal, float, string, All>
        {
