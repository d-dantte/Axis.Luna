namespace Axis.Luna.Unions.Tests
{
    ...
    public class Union7Tests
    {
        ...
        public void Is_Tests()
        {
            ...
            Assert.IsFalse(union.IsOf(out long _));
            ...
            Assert.IsFalse(union.IsOf(out int _));
            Assert.IsFalse(union.IsOf(out uint _));
            Assert.IsTrue(union.IsOf(out long l));
        ...
        internal class MyRefUnion : IUnion<sbyte, byte, short, ushort, int, uint, long, MyRefUnion>
        {
            private readonly object? _value;
            object? IUnion<sbyte, byte, short, ushort, int, uint, long, MyRefUnion>.Value => _value;
