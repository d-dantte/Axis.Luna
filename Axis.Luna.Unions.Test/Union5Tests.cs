namespace Axis.Luna.Unions.Tests
{
    ...
    public class Union5Tests
    {
        ...
        : RefUnion<int, decimal, float, double, string, MyRefUnion>
        {
        ...
        internal class All :
            RefUnion<int, decimal, float, double, string, All>,
            IUnionImplicits<int, decimal, float, double, string, All>,
            IUnionOf<int, decimal, float, double, string, All>
        {
        ...
        internal class DuplicateTypeUnion :
            RefUnion<int, int, int, int, int, DuplicateTypeUnion>,
#pragma warning disable CS1956 // Member implements interface member with multiple matches at run-time
            IUnionImplicits<int, int, int, int, int, DuplicateTypeUnion>
